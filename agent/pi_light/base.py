...
class PiPolicy:  # 有几个路口就会被调用几次
    ...
    def _get_value_for_move2(self, obs, move_id):  # 入射和出射成对考虑 论文用的
        inlane_2_num_vehicle, outlane_2_num_vehicle, inlane_2_num_waiting_vehicle, inlane_2_vehicle_dist, outlane_2_vehicle_dist = obs
        value = [0]
        n_lanelink_id = self.inter.n_roadlink[move_id].n_lanelink_id  # list of tuple
